...
// Inicializar variáveis de formulário (evita notices e facilita reutilização)
            ...
            <div class="navbar-content">
                ...
                <nav class="navbar-menu">
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            <a href="?page=contato" class="nav-link <?php echo $page === 'contato' ? 'active' : ''; ?>">
                                Contato
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="http://teste.solucoesmedicas.online/" class="nav-link nav-link-cta" rel="noopener">Acesso de Clientes</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <p class="hero-description">
                            Digitalize e integre todos os seus processos clínicos e administrativos em uma única plataforma moderna, segura e conforme os padrões do seu convenio parceiro ou do SUS.
                        </p>
                        <div class="hero-cta">
                        ...
                        <div class="contact-form-container">
                            ...
                            <form method="POST" class="contact-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="telefone" name="telefone" class="form-input" value="<?php echo $telefone ?? ''; ?>" placeholder="(81)9 8866-8870">
                                </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="http://teste.solucoesmedicas.online/" rel="noopener">Acesso de Clientes</a></li>
                    </ul>
                </div>
                <div class="footer-section">
