...
--
-- Dumping data for table `evolucao_clinica`
--

LOCK TABLES `evolucao_clinica` WRITE;
/*!40000 ALTER TABLE `evolucao_clinica` DISABLE KEYS */;
INSERT INTO `evolucao_clinica` VALUES (1,11,5,NULL,NULL,'2025-11-09 16:12:28','{\"novo\": \"teste\", \"wfsddasdasd\": \"teste\"}','testetet','1'),(2,10,5,NULL,NULL,'2025-11-09 16:12:53','{\"teste\": [\"sim\"], \"asdasd\": {\"1\": \"1\", \"2\": \"4\", \"3\": \"3\"}, \"teste1\": \"acha que sim\", \"teste_2\": \"nao\", \"testetet\": \"asdfdsvsdfv\", \"teste_2_justificativa\": \"aaaaas\"}','asdsfddfas','1'),(3,11,6,NULL,NULL,'2025-11-09 16:16:32','{\"novo\": \"asadgac\", \"wfsddasdasd\": \"dasdasdasd\"}','asdrasdasd','1'),(4,11,5,NULL,NULL,'2025-11-13 12:24:22','{\"novo\": \"12333333a\", \"wfsddasdasd\": \"asdasd\"}','asdasdasdasdasda','eliabe paz'),(5,12,1,NULL,NULL,'2025-11-16 00:50:17','{\"teste_text\": \"adasdasd\"}','asdasdasd','1');
/*!40000 ALTER TABLE `evolucao_clinica` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `formulario` VALUES (7,'teste','teste 1','FISIO','N',1,'2025-10-07 16:27:02','2025-10-07 16:27:02'),(8,'testeeeeeeeee','tertetewsdfsdf','FONO','N',1,'2025-10-07 21:31:16','2025-10-07 21:31:16'),(9,'teste5','opa','FONO','N',1,'2025-10-09 20:09:05','2025-10-09 20:09:05'),(10,'evolução ao vivo','teste','FONO','N',1,'2025-10-22 13:43:15','2025-10-22 13:43:15'),(11,'09-11_teste','0911','TEOC','S',1,'2025-11-09 17:05:30','2025-11-09 17:05:30'),(12,'teste16-11','16-11-25','FONO','S',1,'2025-11-16 03:30:26','2025-11-16 03:30:26');
...
INSERT INTO `perfil_permissao` VALUES (1,1),(2,1),(1,2),(2,2),(1,3),(2,3),(3,3),(4,3),(5,3);
...
INSERT INTO `perfis` VALUES (1,'admin','Administrador total do sistema',NULL),(2,'secretaria','Acesso a atendimentos e visualização de todas as evoluções',NULL),(3,'fisioterapeuta','Profissional de fisioterapia','FISIO'),(4,'fonoaudiologo','Profissional de fonoaudiologia','FONO'),(5,'terapeuta_ocupacional','Terapeuta ocupacional','TEOC');
...
INSERT INTO `permissoes` VALUES (1,'atendimento.visualizar','Visualizar atendimentos'),(2,'atendimento.criar','Criar novos atendimentos'),(3,'formularios.visualizar','Visualizar todas as evoluções');
...
INSERT INTO `usuarios` VALUES (1,'11123344488','hants','$2y$10$kYIML1hSPAA8/vobCtX3JO0ax3XybwNo/pSiT3/s7O.svTXg21ygG','eliabe paz',1,1,'admin'),(12,'11100011100','fisio','$2y$10$hWOoG/JQzr4cH6FzkB7TI.dRRJvAqZVRq4sZ9I7wfnQfQU1riclZa','FISIOTERAPEUTA',3,1,'user'),(13,'11100011133','fono','$2y$10$viek//WASVmJpV2KN3oFXeKRgnTbcOTdyizqF.AoVxbolxsVsU.Xq','FONOAUDIOLOGO',4,1,'user'),(14,'11100011138','teoc','$2y$10$cFFngltk/cclmUmbcoP5K.KQkjYF6pVmW3nl2Ydi83NXqt/mZbP6.','TERAPEUTA OCUPACIONAL',5,1,'user'),(15,'32113365478','secretaria','$2y$10$iRWIHvEAUHVnWa.N1.WRuOu8VoHV10Cq4FXRUChLF/EIDLnc7x/oS','secretaria',2,1,'user'),(16,'asdasdfasdf','asdfasdfasdf','$2y$10$OcoEtwCxVZ3N9gylZQf22.7pesXxMmRwlMtKgCq9dCMHmqmFE0/WG','hants',2,0,NULL);
...
-- Dump completed on 2025-11-17 23:46:25
