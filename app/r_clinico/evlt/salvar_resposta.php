...
$criado_por = $_SESSION['data_user']['id'];
        ...
        <body>
            <div class="simple-box" style="max-width: 500px; margin: 100px auto; text-align: center;">
                <h2 style="color: #28a745; font-size: 24px; margin-bottom: 20px;">
                    ...
                    Evolução Modificada com sucesso!
                </h2>

                <p style="color: #666; margin-bottom: 30px; font-size: 16px;">
                    Os dados foram alterados de forma segura.
                </p>
...
HTML;
        ...
        die("<h2>Erro ao atualizar evolução</h2><p>" . htmlspecialchars($e->getMessage()) . "</p>");
    }
}
// =============== FIM DA ATUALIZAÇÃO ===============
