...
document.addEventListener('DOMContentLoaded', function() {
    // Verifica se há uma aba ativa definida e mostra seu conteúdo
    const activeTabBtn = document.querySelector('#sub-pacientes .tab-btn.active');
    if (activeTabBtn) {
        const mainId = activeTabBtn.getAttribute('data-main');
        const subId = activeBtn.getAttribute('data-sub');
    ...
    // Inicializa a primeira aba se nenhuma estiver ativa
    if (!activeTabBtn) {
        const firstTabBtn = document.querySelector('#sub-pacientes .tab-btn');
        if (firstTabBtn) {
            firstTabBtn.click();
        }
    }
