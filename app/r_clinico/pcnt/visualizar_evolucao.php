...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>
                <strong>Registro do Paciente:</strong> <?= htmlspecialchars($evolucao['paciente_id'] ?? 'Não informado') ?><br> 
                <strong>Paciente:</strong> <?= htmlspecialchars($paciente['nome'] ?? 'Não informado') ?> <br>
