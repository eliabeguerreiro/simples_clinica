...
INSERT INTO `evolucao_clinica` VALUES (1,7,3,NULL,NULL,'2025-10-14 20:17:13','{\"ig\": \"1\", \"pn\": \"1212\", \"h_d\": \"teste\", \"teste\": {\"gag\": \"não\", \"moro\": \"sim\", \"rtca\": \"não\", \"marcha\": \"sim\", \"plantar\": \"sim\", \"suc%C3%A7%C3%A3o\": \"não\", \"flex%C3%A3o+palmar\": \"sim\", \"libera%C3%A7%C3%A3o+de+vias+a%C3%A9reas\": \"não\"}, \"apgar_1\": \"123\", \"apgar_5\": \"123\", \"brincar\": \"\", \"medica____es\": \"teste\", \"prematuridade\": \"NÃO\", \"tipo_do_parto\": \"cesáreo\", \"intecorrencias\": \"parto\", \"queixa_principal\": \"123123\", \"internamento_em_uti_neonatal\": \"\", \"internamento_em_uti_neonatal_\": \"NÃO\", \"descri____o_das_intercorr__ncias\": \"123\", \"aspectos_relacionados____alimenta____o\": \"\"}','opa','eliabe paz');
...
CREATE TABLE `formulario` (
  ...
  KEY `idx_ativo` (`ativo`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Templates de formulários para evoluções';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `formulario` VALUES (7,'teste','teste 1','FISIO','N',1,'2025-10-07 16:27:02','2025-10-07 16:27:02'),(8,'testeeeeeeeee','tertetewsdfsdf','FONO','N',1,'2025-10-07 21:31:16','2025-10-07 21:31:16'),(9,'teste5','opa','FONO','N',1,'2025-10-09 20:09:05','2025-10-09 20:09:05');
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Perguntas dos formulários';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-14 20:48:17
